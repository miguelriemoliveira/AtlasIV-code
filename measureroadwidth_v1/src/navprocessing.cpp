...
// 	#endif
	...
	NAVP_GetDAbyPP();
	NAVP_CheckLineSteping(mask_Img1,&Table_LineNumber,&Table_RoadWidth);
		...
		if (SquareRegion.ValidLowGoToPoint) //test for point relocation
		{
			...
			{	
				...
				if (SquareRegion.LowGoToPoint[0] < 239-30)
					SquareRegion.LowGoToPoint[0] = SquareRegion.LowGoToPoint[0] +80;
			}
	...
	if(SquareRegion.OSearch.topl.valid && SquareRegion.OSearch.topr.valid)
	{
		...
		if (SquareRegion.ValidTopGoToPoint)//test for relocation
		{
			...
			{	
				...
				if (SquareRegion.TopGoToPoint[0] < 239-80)
					SquareRegion.TopGoToPoint[0] = SquareRegion.TopGoToPoint[0] +80;
				else 
	...
	if(SquareRegion.OSearch.lowl.valid)
	{
		...
		if (SquareRegion.ValidLowLeftGoToPoint)//test for relocation
		{
			...
			{	
				...
				SquareRegion.LowLeftGoToPoint[1] = (SquareRegion.LowLeftGoToPoint[1] - cont1) + (SquareRegion.LowLeftGoToPointWidth/2);
				if (SquareRegion.LowGoToPoint[0] < 239-30)
					SquareRegion.LowGoToPoint[0] = SquareRegion.LowGoToPoint[0] +30;
				else 
					SquareRegion.LowGoToPoint[0]=239;
			}	
		}
	}
