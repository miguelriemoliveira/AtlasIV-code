...
*/
#define POUT 1 				//flag to print out

/*! @define NPOUT
* @brief This is used not to print out information to the shell.
*/
#define NPOUT 0 			//flag not to print out

/*! @define IPAINT
* @brief This is used to draw in the window's images.
*/
#define IPAINT 1			//flag to paint image with values
...
*/
#define COM_DEVICE_PIC1 "/dev/ttyUSB0"	//device to assign to PIC1

/*! @define USEPIC1COMS
* @brief Flag to use or not pic1 comunications.
*/
#define USEPIC1COMS 0			//flag to use PIC1 comunnications [0 or 1]

/*! @define COM_DEVICE_PIC2
* @brief Defines the path to the serial port connected to pic 2
*/
#define COM_DEVICE_PIC2 "/dev/ttyUSB1"	//device to assign to PIC2
/*! @define USEPIC2COMS
* @brief Flag to use or not pic2 comunications.
*/
#define USEPIC2COMS 0  			//flag to use PIC2 comunnications [0 or 1]
/*----------------------------------*/
...
*/
#define LIGHTSCAM_N 1			//IMPORTANT: LIGHTSCAM is 1 because it is receiving power from NAVCAM
/*----------------------------------*/
...
#define IMAGESIZE cvSize(320,240)	//WARNING: other possibilities not tested. Probably crashes
...
//#define TDTSSize 19	
#define TDTSSize 11	
#define MAXADMISSIBLEROADWIDTH 1.3 //from 1 to whatever
