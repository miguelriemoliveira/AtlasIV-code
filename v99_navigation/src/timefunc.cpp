...
{char str[255];
	...
	Time.Since.LastStopMode= TM_TimeSince(&Time.Tick.LastStopMode);
		...
		sprintf(str,"L.StopMode= %d",Time.Since.LastStopMode);
		cvPutText(GI.Data.Info, str, cvPoint(160,180),&font, CV_RGB(250,120,10));	
	#endif
